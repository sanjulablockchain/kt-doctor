...
//   including all 5 Camarillo-only doctors) were initially kept as-is and
//   flagged rather than deleted. After shipping that version, the client
//   compared the live site against Healow's own booking widget location by
//   location and found the extra, unconfirmed doctors showing up
//   side-by-side with real Healow-confirmed ones (e.g. Santa Monica showing
//   6 doctors on our site vs. 2 on Healow) — confusing rather than helpful.
//   Per follow-up client decision (2026-07-17), all 49 unconfirmed doctors
