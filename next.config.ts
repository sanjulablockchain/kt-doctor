...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/locations/agoura-hills-pediatrician", destination: "/locations/agoura-hills", permanent: true },
      { source: "/locations/arcadia-clinic", destination: "/locations/arcadia", permanent: true },
      { source: "/locations/beverly-hills-clinic", destination: "/locations/beverly-hills", permanent: true },
      { source: "/locations/camarillo-pediatric-clinic", destination: "/locations/camarillo", permanent: true },
      { source: "/locations/canyon-country-pediatric-clinic", destination: "/locations/canyon-country", permanent: true },
      { source: "/locations/culver-city-pediatric-clinic", destination: "/locations/culver-city", permanent: true },
      { source: "/locations/glendale-pediatric-clinic", destination: "/locations/glendale", permanent: true },
      { source: "/locations/hollywood-clinic", destination: "/locations/hollywood", permanent: true },
      { source: "/locations/la-canada-flintridge", destination: "/locations/la-canada", permanent: true },
      { source: "/locations/pico-rivera-pediatric-clinic", destination: "/locations/pico-rivera", permanent: true },
      { source: "/locations/san-fernando-pediatric-clinic", destination: "/locations/san-fernando", permanent: true },
      { source: "/locations/santa-monica-pediatric-clinic", destination: "/locations/santa-monica", permanent: true },
      { source: "/locations/san-pedro-pediatric-clinic", destination: "/locations/san-pedro", permanent: true },
      { source: "/locations/tarzana-pediatric-clinic", destination: "/locations/tarzana", permanent: true },
      { source: "/locations/torrance-pediatric-clinic", destination: "/locations/torrance", permanent: true },
      { source: "/locations/valencia-pediatric-clinic", destination: "/locations/valencia", permanent: true },
      { source: "/locations/van-nuys-pediatric-clinic", destination: "/locations/van-nuys", permanent: true },
      { source: "/locations/west-hills-pediatric-clinic", destination: "/locations/west-hills", permanent: true },
      {
        source: "/locations/whittier-pediatric-clinic-whitter-telehealth-kidsandteens",
        destination: "/locations/whittier",
        permanent: true,
      },
      { source: "/locations/la-mirada-clinic", destination: "/locations/la-mirada", permanent: true },
